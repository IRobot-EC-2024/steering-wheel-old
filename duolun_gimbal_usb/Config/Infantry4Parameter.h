...
#define ROTOR_TIMESET_BUSY 68              // 68//���̵���תʱ��
#define ROTOR_TIMESET_COOLING 2            // 2//��һ����Ƶ
#define ROTOR_TIMESET_COOLING_SECOND 120   // 80//�ڶ���
#define ROTOR_TIMESET_RESERVE 35           // 35//��ת�Ժ�ת��ʱ��
#define ROTOR_LAGGING_COUNTER_MAX 42       // 42��ת��ʱ
